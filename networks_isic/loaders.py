...
def get_loaders(dfs, size=100, batch_size=1, num_workers=1, shuffle=False, sampler=None):
    """
    ...
    # Loaders
    dataloaders = {x: DataLoader(image_datasets[x], batch_size, num_workers, shuffle, sampler) for x in dfs.keys()}
