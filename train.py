...
"""
Train.py
This script trains a model in the ISIC19 project.
...
def train_eval(fold, dataloaders, dataset_sizes, net, criterion, optimizer, num_epochs):
    """
    ...
    for epoch in range(epoch, num_epochs+1):
        ...
        for phase in ['train','val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                with open (os.path.join(args.model_dir, f'metrics{fold}.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    for fold in range(1, args.folds+1):
        ...
        train_eval(fold, dataloaders, dataset_sizes, net, criterion, optimizer, num_epochs=params.num_epochs)
